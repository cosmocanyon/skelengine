...
INCLUDE_PATH := -I../code/include \
	-I${DEV_DIR}/SDL2/include -I${DEV_DIR}/SDL2_image/include -I${DEV_DIR}/SDL2_ttf/include \
	-I${DEV_DIR}/SDL2_mixer/include -I${DEV_DIR}/glew/include/GL -I${DEV_DIR}/glm \
	-I${DEV_DIR}/stb-master
LIB_PATH := -LIBPATH:${DEV_DIR}/SDL2/lib/x64 -LIBPATH:${DEV_DIR}/SDL2_image/lib/x64 \
	-LIBPATH:${DEV_DIR}/SDL2_ttf/lib/x64 -LIBPATH:${DEV_DIR}/SDL2_mixer/lib/x64 \
	-LIBPATH:${DEV_DIR}/glew/lib/Release/x64
LIBRARY := SDL2main.lib SDL2.lib glu32.lib Shell32.lib glew32.lib opengl32.lib SDL2_image.lib SDL2_ttf.lib SDL2_mixer.lib
